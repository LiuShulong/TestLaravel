...
<div class="bk_title_bar">
  <img class="bk_back" src="http://127.0.0.1:8080/images/back.png" alt="" onclick="history.go(-1);">
  <p class="bk_title_content"></p>
  <img class="bk_menu" src="http://127.0.0.1:8080/images/menu.png" alt="" onclick="onMenuClick();">
</div>
